...
class Database {
	 ...
	 * Database class
     * for documentation https://github.com/rorystandley/mysqli-crud-php-oop 
	 */

	private $db_host = "localhost";  // Change as required
	private $db_user = "root";  // Change as required
	private $db_pass = "836533";  // Change as required
	private $db_name = "permohonan_ssl";	// Change as required
